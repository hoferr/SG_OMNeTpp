...
#ifndef __ADAPTER_PLC_BASE_H__
#define __ADAPTER_PLC_BASE_H__
 ...
 */
class INET_API Adapter_PLC_Base : public cSimpleModule, public INotifiable
{
  protected:
