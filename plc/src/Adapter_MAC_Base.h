...
/*
	...
	This module is nearly the same as the EtherMACBase module, with the only exeption, that it
	does not block messages because of a non-fitting MAC address (since it belongs to an adapter, which
	should forward all messages).
*/

#ifndef __ADAPTER_MAC_BASE_H__
#define __ADAPTER_MAC_BASE_H__
 ...
 */
class INET_API Adapter_MAC_Base : public cSimpleModule, public INotifiable
{
  protected:
