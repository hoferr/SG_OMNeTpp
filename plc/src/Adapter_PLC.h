...
#ifndef __INET_ADAPTER_PLC_H
#define __INET_ADAPTER_PLC_H
...
class INET_API Adapter_PLC : public Adapter_PLC_Base
{
  public:
	Adapter_PLC();
    virtual ~Adapter_PLC();
...
extern "C" cSimpleModule* createAdapter_PLC(){
	return new Adapter_PLC();
}

extern "C" void destroyAdapter_PLC(cSimpleModule * csm){
	delete csm;
}
