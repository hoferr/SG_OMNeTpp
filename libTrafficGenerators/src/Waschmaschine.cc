...
Register_Class(Waschmaschine);
Define_Module(Waschmaschine);

void Waschmaschine::initialize()
{
...
void Waschmaschine::handleMessage(cMessage *msg)
{
...
std::string Waschmaschine::info(){
	std::cout << "moeff"<<endl;
	return "moeff";
//	return new Waschmaschine();
}

void Waschmaschine::getWaschmaschine(){
	std::cout << "moep" <<endl;
//	return new Waschmaschine();
}

void Waschmaschine::finish()
{
...
inline int Waschmaschine::variation()
{
