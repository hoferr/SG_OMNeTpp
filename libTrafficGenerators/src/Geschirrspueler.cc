#include "Geschirrspueler.h"

Register_Class(Geschirrspueler);
Define_Module(Geschirrspueler);

void Geschirrspueler::initialize()
{
...
void Geschirrspueler::handleMessage(cMessage *msg)
{
...
std::string Geschirrspueler::info(){
	std::cout << "moeff"<<endl;
	return "moeff";
//	return new Geschirrspueler();
}

void Geschirrspueler::getGeschirrspueler(){
	std::cout << "moep" <<endl;
//	return new Geschirrspueler();
}

void Geschirrspueler::finish()
{
...
inline int Geschirrspueler::variation()
{
