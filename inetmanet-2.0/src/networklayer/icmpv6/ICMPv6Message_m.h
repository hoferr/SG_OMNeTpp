 ...
 * </pre>
 */
class INET_API ICMPv6Message : public ::cPacket
{
  protected:
    int type_var;
 ...
 * </pre>
 */
class INET_API ICMPv6DestUnreachableMsg : public ::ICMPv6Message
{
  protected:
    int code_var;
 ...
 * </pre>
 */
class INET_API ICMPv6PacketTooBigMsg : public ::ICMPv6Message
{
  protected:
    int code_var;
    int MTU_var;
 ...
 * </pre>
 */
class INET_API ICMPv6TimeExceededMsg : public ::ICMPv6Message
{
  protected:
    int code_var;
 ...
 * </pre>
 */
class INET_API ICMPv6ParamProblemMsg : public ::ICMPv6Message
{
  protected:
    int code_var;
 ...
 * </pre>
 */
class INET_API ICMPv6EchoRequestMsg : public ::ICMPv6Message
{
  protected:
    int code_var;
    int identifier_var;
 ...
 * </pre>
 */
class INET_API ICMPv6EchoReplyMsg : public ::ICMPv6Message
{
  protected:
    int code_var;
    int identifier_var;
