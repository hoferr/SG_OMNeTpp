...
/**
 * Class generated from <tt>networklayer/manetrouting/PASER/simple_kdc/kdc_message/crl_message.msg</tt> by opp_msgc.
 * <pre>
 * packet crl_message {
 *     In_addr src;
 *     In_addr gwAddr;
 ...
 * </pre>
 */
class INET_API crl_message : public ::cPacket
{
  protected:
    In_addr src_var;
    In_addr gwAddr_var;
