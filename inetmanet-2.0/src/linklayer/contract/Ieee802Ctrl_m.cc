...
int Ieee802CtrlDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "ssap")==0) return base+4;
    if (fieldName[0]=='d' && strcmp(fieldName, "dsap")==0) return base+5;
    if (fieldName[0]=='p' && strcmp(fieldName, "pauseUnits")==0) return base+6;
...
std::string Ieee802CtrlDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 4: return long2string(pp->getSsap());
        case 5: return long2string(pp->getDsap());
        case 6: return long2string(pp->getPauseUnits());
        default: return "";
    }
}
...
bool Ieee802CtrlDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 4: pp->setSsap(string2long(value)); return true;
        case 5: pp->setDsap(string2long(value)); return true;
        case 6: pp->setPauseUnits(string2long(value)); return true;
