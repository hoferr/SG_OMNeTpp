...
std::string EthernetIIFrameDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return long2string(pp->getEtherType());
        default: return "";
    }
}
...
bool EthernetIIFrameDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 1: pp->setEtherType(string2long(value)); return true;
        default: return false;
    }
}
...
int Ethernet1QTag::getVID() const
{
    return VID_var;
}

void Ethernet1QTag::setVID(int VID)
{
    this->VID_var = VID;
}
...
std::string Ethernet1QTagDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        case 0: return oppstring2string(pp->getDisplayString());
        case 1: return long2string(pp->getVID());
        default: return "";
    }
}
...
bool Ethernet1QTagDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        case 0: pp->setDisplayString((value)); return true;
        case 1: pp->setVID(string2long(value)); return true;
        default: return false;
    }
}
...
{
    this->displayString_var = "b=,,,#3ea53e";
    this->ISid_var = 0;
}
...
const char * Ethernet1ahITag::getDisplayString() const
{
    return displayString_var.c_str();
}

void Ethernet1ahITag::setDisplayString(const char * displayString)
{
    this->displayString_var = displayString;
}
...
int Ethernet1ahITagDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    int base = basedesc ? basedesc->getFieldCount(object) : 0;
    if (fieldName[0]=='d' && strcmp(fieldName, "displayString")==0) return base+0;
    if (fieldName[0]=='I' && strcmp(fieldName, "ISid")==0) return base+1;
    return basedesc ? basedesc->findField(object, fieldName) : -1;
}
...
std::string Ethernet1ahITagDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        case 0: return oppstring2string(pp->getDisplayString());
        case 1: return long2string(pp->getISid());
        default: return "";
    }
}
...
bool Ethernet1ahITagDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        case 0: pp->setDisplayString((value)); return true;
        case 1: pp->setISid(string2long(value)); return true;
        default: return false;
    }
}
