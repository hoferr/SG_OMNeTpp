...
void SCTPOpenCommand::setLocalPort(int localPort)
{
...
void SCTPOpenCommand::setRemotePort(int remotePort)
{
...
int SCTPOpenCommandDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='i' && strcmp(fieldName, "inboundStreams")==0) return base+8;
    if (fieldName[0]=='o' && strcmp(fieldName, "outboundStreams")==0) return base+9;
    if (fieldName[0]=='s' && strcmp(fieldName, "streamReset")==0) return base+10;
    if (fieldName[0]=='p' && strcmp(fieldName, "prMethod")==0) return base+11;
    if (fieldName[0]=='n' && strcmp(fieldName, "numRequests")==0) return base+12;
    if (fieldName[0]=='m' && strcmp(fieldName, "messagesToPush")==0) return base+13;
    return basedesc ? basedesc->findField(object, fieldName) : -1;
}
...
std::string SCTPOpenCommandDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 8: return ulong2string(pp->getInboundStreams());
        case 9: return ulong2string(pp->getOutboundStreams());
        case 10: return bool2string(pp->getStreamReset());
        case 11: return long2string(pp->getPrMethod());
        case 12: return ulong2string(pp->getNumRequests());
        case 13: return ulong2string(pp->getMessagesToPush());
        default: return "";
    }
}
...
bool SCTPOpenCommandDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 8: pp->setInboundStreams(string2ulong(value)); return true;
        case 9: pp->setOutboundStreams(string2ulong(value)); return true;
        case 10: pp->setStreamReset(string2bool(value)); return true;
        case 11: pp->setPrMethod(string2long(value)); return true;
        case 12: pp->setNumRequests(string2ulong(value)); return true;
        case 13: pp->setMessagesToPush(string2ulong(value)); return true;
        default: return false;
    }
}
...
void SCTPConnectInfo::setLocalPort(int localPort)
{
    this->localPort_var = localPort;
}
...
void SCTPConnectInfo::setRemotePort(int remotePort)
{
    this->remotePort_var = remotePort;
}
